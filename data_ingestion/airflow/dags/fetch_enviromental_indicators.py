...
def run_environmental_indicators_ingestion():
    try:
        subprocess.run(
        ...
        print(f"Error during environmental indicators ingestion: {e}")
...
run_task = PythonOperator(
    task_id='run_environmental_indicators_ingestion',
    python_callable=run_environmental_indicators_ingestion,
    dag=dag,
)
