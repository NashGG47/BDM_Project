...
#paths
DELTA_TABLE_PATHS = {
    "renfe_incidents": "storage/delta/raw/renfe_incidents",
}
METADATA_FILE = "storage/delta/raw/metadata/renfe_incidents.json"
...
def process_messages():
    ...
    for message in consumer:
        ...
        if len(batch_data) >= 10:
            ...
            store_in_delta("renfe_incidents", df)
            log_metadata("renfe_incidents", len(batch_data))
            batch_data = []
